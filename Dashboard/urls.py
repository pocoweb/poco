...
urlpatterns = patterns('',
    ...
    url(r'^report/(?P<site_id>.+)/$', 'Dashboard.views.report'),
    ...
    url(r'^ajax/report/(?P<site_id>\w+)$', 'Dashboard.views.ajax_report'),
    url(r'^ajax/report/(?P<site_id>\w+)/(?P<report_type>\w+)$', 'Dashboard.views.ajax_report'),
    url(r'^ajax/report/(?P<site_id>\w+)/(?P<report_type>\w+)/(?P<date>[\d-]+)$', 'Dashboard.views.ajax_report'),
)
